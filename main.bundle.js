...
var Ajax = function () {
  ...
  _createClass(Ajax, null, [{
    ...
    key: 'postColor',
    value: function postColor(data) {
      $.post(baseUrl + '/api/v1/colors', { color: { value: data } }).done(console.log("Posted successfully"));
    }
  }]);
...
$("button").click(function () {
  ...
  var uniqueSwatch = swatch.filter(onlyUnique);
